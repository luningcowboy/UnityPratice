...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp19(UnityEngine.Collider2D p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp20(UnityEngine.Collision2D p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<float, float>(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(System.Action<float, float, float>))
			{
			    return new System.Action<float, float, float>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Collider>))
			{
			    return new System.Action<UnityEngine.Collider>(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Collision>))
			{
			    return new System.Action<UnityEngine.Collision>(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Collider2D>))
			{
			    return new System.Action<UnityEngine.Collider2D>(__Gen_Delegate_Imp19);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Collision2D>))
			{
			    return new System.Action<UnityEngine.Collision2D>(__Gen_Delegate_Imp20);
			}
		
		    if (type == typeof(System.Func<float>))
			{
			    return new System.Func<float>(__Gen_Delegate_Imp21);
			}
