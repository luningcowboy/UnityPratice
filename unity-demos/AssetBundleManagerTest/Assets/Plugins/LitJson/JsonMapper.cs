...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        public static readonly IDictionary<Type,
        ...
        public static string ToJsonReplaceParam(object obj)
        {
            lock (static_writer_lock)
            {
                static_writer.Reset();
                ...
                string str = static_writer.ToString();
                str = str.Replace("param", "params");
                return str;
            }
        }
