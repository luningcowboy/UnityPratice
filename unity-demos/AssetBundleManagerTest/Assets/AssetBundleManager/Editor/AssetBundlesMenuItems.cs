...
namespace AssetBundles
{
    public static class AssetBundlesMenuItems
    {
        ...
        {
            if (!BuildScript.BuildAssetBundles(BuildAssetBundleOptions.ChunkBasedCompression))
        ...
        {
            if (!BuildScript.BuildAssetBundles(BuildAssetBundleOptions.ForceRebuildAssetBundle | BuildAssetBundleOptions.ChunkBasedCompression))
